...
simulation<-readline(prompt = "single site simulation (1) or multisite (2)?")
print(simulation)
...
if (simulation == 1){
    ...
    match<-"no"
    print("Available site(s):")
    for (i in 1: length(site_counter<-table(site_list))) print(site_list[i])
