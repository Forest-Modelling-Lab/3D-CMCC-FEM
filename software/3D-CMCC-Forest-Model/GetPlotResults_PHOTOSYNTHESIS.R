...
climate_off_list<-c('on')    # ("on",off","All") for climate off and co2 on
photosynthesis_list<-c('All') #("FvCB",'LUE') for photosyhtesis approach
#lue_list<-c("Fra")            #('FvCB','LUE') for lue approach
time_list = c('annual')

#  output folder name
output_folder = paste0("Test_output_Rstudio_ct_photosynthesis_24_Gen_TEST_", protocol_list,'_',co2_list)
        ...
        if (local_list == 'on' || protocol_list == 'LOCAL')
        {
          ...
          if ( files_to_check_id == 0 ) {
            ...
            systemCall  <- paste0(build_list,'/3D_CMCC_Forest_Model', " ",
                                  ...
                                  "-o"," ", "output/",output_folder,"-", version, "-", site,"/",protocol,"-",photosynthesis," ",
            ...
            for (rcp in rcp_list) {
              ...
              if ( files_to_check_id2 == 0 ) {
                ...
                cat(paste0("start 3D-CMCC ",
                           ...
                           " ESM: ", esm," RCP: ", rcp," CO2 RCP: ", rcp," Manag-", man, " CO2-", co2, ' photosynthesis-',photosynthesis,'\n'))
                ...
                systemCall  <- paste0(build_list,'/3D_CMCC_Forest_Model', " ",
                                      ...
                                      ">output/",output_folder,"-", version, "-", site,"/",protocol,"_log_",site,"_",protocol, "_ESM_", esm,"_RCP_", rcp,"_CO2_RCP_", rcp,'_',photosynthesis,"_Manag-", man, "_CO2-", co2,".txt"
                )
                ...
                cat(paste0("start 3D-CMCC ",
                           "protocol: ",protocol, " site: ", site, 
                           " ESM: ", esm," RCP: ", rcp," CO2 RCP: ", rcp,'_',photosynthesis_list,"_Manag-", man, " CO2-", co2,' ... COMPLETE!\n'))
                ...
                if ( rcp == '0p0' && co2 == 'on' && climate_off_list == 'on' )
                 {
                   for (rcp2 in rcp_list)
                   {
                     ...
                     systemCall  <- paste0(build_list,'/3D_CMCC_Forest_Model', " ",
                                           ...
                                           "_ESM_", esm,"_RCP_",rcp,"_CO2_RCP_",rcp2,'_',photosynthesis,"_Manag-", man, "_CO2-", co2,".txt"
                     )
                     ...
                     cat(paste0("start 3D-CMCC ",
                                "protocol: ",protocol, " site: ", site, 
                                " ESM: ", esm," RCP: ", rcp," CO2 RCP: ", rcp2,'_',photosynthesis_list,"_Manag-", man, " CO2-", co2,' ... COMPLETE!\n'))
                   }
                 }
              }
            }
