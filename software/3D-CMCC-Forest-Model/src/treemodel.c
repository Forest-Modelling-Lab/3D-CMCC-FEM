				...
				for (species = 0; species < m->cells[cell].heights[height].ages[age].species_count; species++)
				{
					...
					if (m->cells[cell].heights[height].ages[age].species[species].period == 0)
					{
						...
						else
						{
							...
							// ALESSIOR was using bad parameters. fixed.
							E_Get_Partitioning_Allocation (&m->cells[cell].heights[height].ages[age].species[species], &m->cells[cell], met, month, day, DaysInMonth[month], years,  height, age, species);
						...
						if (month == DECEMBER)
						{
                           ...
                           if ( m->cells[cell].heights[height].ages[age].species[species].counter[N_TREE_SAP] != 0 && m->cells[cell].heights[height].z == m->cells[cell].top_layer )
                           {
                                ...
                                m->cells[cell].heights[m->cells[cell].heights_count-1].ages[0].species[0].value[BIOMASS_FOLIAGE] = m->cells[cell].heights[height].ages[age].species[species].value[WF_SAP];
                                ...
                                m->cells[cell].heights[m->cells[cell].heights_count-1].ages[0].species[0].value[BIOMASS_STEM] = m->cells[cell].heights[height].ages[age].species[species].value[WS_SAP];
