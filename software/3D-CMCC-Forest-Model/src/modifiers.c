...
void Get_daily_modifiers (SPECIES *const s,  AGE *const a, CELL *const c, const MET_DATA *const met, int year,  int month, int day, int daysinmonth, double available_soil_water, double vpd,  int z, int management, int height )
{
	double RelAge;
...
//void Get_modifiers (SPECIES *const s,  AGE *const a, CELL *const c, const MET_DATA *const met, int year,  int month, int daysinmonth, double available_soil_water, double vpd,  int z, int management, int height)
//{
//	double RelAge;
//
//	double vwc; //soil volumetric water content
