...
void modifiers(cell_t *const c, const int layer, const int height, const int age, const int species, const int management, const meteo_daily_t *const meteo_daily)
{
	double RelAge;
