...
enum {
	...
	BIOMASS_STEM_C,
	BIOMASS_BRANCH_C,
	BIOMASS_TOT_STEM_C,//STEM + BRANCH AND BARK
	RESERVE_C,
	BIOMASS_FRUIT_C,
	BIOMASS_LIVE_WOOD_C,
	BIOMASS_DEAD_WOOD_C,
	BIOMASS_STEM_LIVE_WOOD_C,
	BIOMASS_STEM_DEAD_WOOD_C,
	BIOMASS_COARSE_ROOT_LIVE_WOOD_C,
	BIOMASS_COARSE_ROOT_DEAD_WOOD_C,
	BIOMASS_BRANCH_LIVE_WOOD_C,
