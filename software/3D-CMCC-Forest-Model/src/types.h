...
enum {
	...
	CANOPY_CONDUCTANCE,
	INTERCEPTION,                   //Rain Interception
...
extern void M_D_Get_Partitioning_Allocation_CTEM (SPECIES *const, CELL *, const MET_DATA *const, int, int, int, float, int, int, int);
