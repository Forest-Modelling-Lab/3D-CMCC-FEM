...
char *getdsp (void);
char *getfil (void);
void  getgrf (float *a, float *e, float *or, float *step, char *cax);
int   gethgt (void);
...
void  graf   (float xa, float xe, float xor, float xstp,
              float ya, float ye, float yor, float ystp);
void  graf3  (float xa, float xe, float xor, float xstp,
              float ya, float ye, float yor, float ystp,
              float za, float ze, float zor, float zstp);
void  graf3d (float xa, float xe, float xor, float xstp,
              float ya, float ye, float yor, float ystp,
              float za, float ze, float zor, float zstp);
void  grafmp (float xa, float xe, float xor, float xstp,
              float ya, float ye, float yor, float ystp);
...
void  xaxgit (void);
void  xaxis  (float xa, float xe, float xor, float xstp, 
              int nl, char *cstr, int it, int nx, int ny);
void  xaxlg  (float xa, float xe, float xor, float xstp,
              int nl, char *cstr, int it, int nx, int ny);
void  xaxmap (float xa, float xe, float xor, float xstp,
