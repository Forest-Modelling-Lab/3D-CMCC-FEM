...
void littering ( cell_t *const c, species_t *const s )
{
	...
	s->value[FROOT_TO_LITR1C]           = s->value[C_FROOT_TO_LITR]     * s->value[LEAF_LITR_LAB_FRAC] ;
	s->value[FROOT_TO_LITR2C]           = s->value[C_FROOT_TO_LITR]     * s->value[LEAF_LITR_USCEL_FRAC];
	s->value[FROOT_TO_LITR3C]           = s->value[C_FROOT_TO_LITR]     * s->value[LEAF_LITR_SCEL_FRAC];
	s->value[FROOT_TO_LITR4C]           = s->value[C_FROOT_TO_LITR]     * s->value[LEAF_LITR_LIGN_FRAC];
	/* check */
	CHECK_CONDITION ( s->value[LEAF_TO_LITR1C] + s->value[LEAF_TO_LITR2C] + s->value[LEAF_TO_LITR3C] + s->value[LEAF_TO_LITR4C], == , s->value[LEAF_TO_LITRC] + eps );
	...
	s->value[FROOT_TO_LITR1N]           = s->value[N_FROOT_TO_LITR]     * s->value[LEAF_LITR_LAB_FRAC] ;
	s->value[FROOT_TO_LITR2N]           = s->value[N_FROOT_TO_LITR]     * s->value[LEAF_LITR_USCEL_FRAC];
	s->value[FROOT_TO_LITR3N]           = s->value[N_FROOT_TO_LITR]     * s->value[LEAF_LITR_SCEL_FRAC];
	s->value[FROOT_TO_LITR4N]           = s->value[N_FROOT_TO_LITR]     * s->value[LEAF_LITR_LIGN_FRAC];
	/* check */
	CHECK_CONDITION ( s->value[LEAF_TO_LITR1N] + s->value[LEAF_TO_LITR2N] + s->value[LEAF_TO_LITR3N] + s->value[LEAF_TO_LITR4N], == , s->value[LEAF_TO_LITRN] + eps );
