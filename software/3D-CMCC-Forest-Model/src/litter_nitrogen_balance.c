...
void litter_nitrogen_balance (cell_t *const c)
{
	...
	c->daily_litr2N       = ( c->daily_leaf_to_litr2N + c->daily_litr3N_to_litr2N + c->daily_cwd_to_litr2N + c->daily_froot_to_litr2N)
	...
	c->daily_soil2N      += c->daily_litr2N_to_soil2N;
	c->daily_soil3N      += c->daily_litr4N_to_soil3N;
	c->daily_soilN       += c->daily_soil1N + c->daily_soil2N + c->daily_soil3N;
