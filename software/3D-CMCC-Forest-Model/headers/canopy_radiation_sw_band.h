...
void canopy_sw_band_abs_trans_refl_radiation(cell_t *const c, const int layer, const int height, const int age, const int species, double Light_abs_frac, double Light_abs_frac_sun, double Light_abs_frac_shade, double Light_refl_par_frac, double Light_refl_sw_rad_canopy_frac);
