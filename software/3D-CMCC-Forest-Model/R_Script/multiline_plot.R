...
input_dir = ('/home/alessio/git/3D-CMCC-LAND/software/3D-CMCC-Forest-Model/output/output_Rstudio-5.3.2-ISIMIP-Hyytiala-2B/output_5.3.2-ISIMIP_2017_MAY_04/annual/')
