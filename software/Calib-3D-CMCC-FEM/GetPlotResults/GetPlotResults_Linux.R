...
systemCall  <- paste0("3D-CMCC-Forest-Model/3D_CMCC_Forest_Model"," ",
                      ...
                      "-o"," ", "output/prova_Rstudio"," ",
                      "-d"," ", "PAPER/Soroe_stand_ISIMIP.txt", " ",
                      "-m"," ", "PAPER/GCM3/GCM3_rcp8p5.txt"," ",
...
#output model DAILY
pdf("./3D-CMCC-Forest-Model/output/prova_Rstudio/output_5.3.2-ISIMIP_2017_APRIL_19/daily/Daily.pdf",onefile = T,width = 15,height = 12)
par(mfrow=c(4,4))
...
pdf("./3D-CMCC-Forest-Model/output/prova_Rstudio/output_5.3.2-ISIMIP_2017_APRIL_19/monthly/Monthly.pdf",onefile = T,width = 15,height = 12)
par(mfrow=c(4,4))
...
#output model ANNUAL
pdf("./3D-CMCC-Forest-Model/output/prova_Rstudio/output_5.3.2-ISIMIP_2017_APRIL_19/annual/Annual.pdf",onefile = T,width = 15,height = 12)
par(mfrow=c(4,4))
