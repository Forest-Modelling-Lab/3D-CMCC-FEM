...
typedef struct
{
	...
	//int saplings_counter;                                                 /* (trees/cell) number of class as sapling */ // COLLALTI
	...
	/* SOIL AND LITTER INITIALIZATION */
	/* from "soil.txt" file */
	double lat;                                                           /* latitude */
	...
	//double Seeds_C;                                                       /* (gC/m2/year) Carbon derived from seeds */
	//double Seedling_C;                                                   /* (gC/m2/year) Carbon derived from seedlings */
	//double Saplings_C;                                                   /* (gC/m2/year) Carbon derived from saplings */
